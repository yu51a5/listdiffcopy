...
class StoragePCloud(StorageBase):
  ...
  def __init__(self, is_eapi=pcloud_urls_are_eapi, secret_name=None, logger=None):
    super().__init__(constructor_kwargs=dict(is_eapi=is_eapi, secret_name=secret_name), logger=logger)
